...
for module_id = module_ids
    ...
    for delay_s = cfg.delay_s_list
        design = design_delay_pm_pi( ...
            module_cfg.current_loop.effective_phase_resistance_ohm, ...
            module_cfg.current_loop.effective_phase_inductance_h, ...
...
design_table = cell2table(design_rows, 'VariableNames', { ...
    ...
    'effective_phase_resistance_ohm', 'effective_phase_inductance_h', ...
...
simcfg.design_rs = module_cfg.current_loop.effective_phase_resistance_ohm;
simcfg.design_lq = module_cfg.current_loop.effective_phase_inductance_h;
...
cases = [ ...
    ...
    struct('name', "1620_800hz_pole_cancel", ...
        'kp', module_cfg.current_loop.effective_phase_inductance_h * wc_800, ...
        'ki', module_cfg.current_loop.effective_phase_resistance_ohm * wc_800, ...
        'design_delay_s', NaN, ...
        'note', "800 Hz no-delay pole-cancel reference"); ...
    struct('name', string(['1620_' target_bw_token '_pole_cancel']), ...
        'kp', module_cfg.current_loop.effective_phase_inductance_h * wc_target, ...
        'ki', module_cfg.current_loop.effective_phase_resistance_ohm * wc_target, ...
        'design_delay_s', 0.0, ...
...
for delay_s = cfg.delay_s_list
    design = design_delay_pm_pi( ...
        module_cfg.current_loop.effective_phase_resistance_ohm, ...
        module_cfg.current_loop.effective_phase_inductance_h, ...
        cfg.target_bandwidth_hz, cfg.phase_margin_deg, delay_s);

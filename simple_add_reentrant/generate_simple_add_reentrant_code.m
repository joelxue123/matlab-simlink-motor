%% Generate embedded C code for simple_add_reentrant

clear; clc;

script_dir = fileparts(mfilename('fullpath'));
run(fullfile(script_dir, 'build_simple_add_reentrant_model.m'));

cfg = evalin('base', 'reentrant_add_codegen_config');
model = cfg.modelName;
